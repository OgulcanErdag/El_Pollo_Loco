...
class Statusbar extends DrawableObject {
    ...
    /** 
     * Array of image paths for different health status levels.
     * @type {Array<string>}
     */
    IMAGES = [
    ...
    /** 
     * The percentage of health displayed on the status bar.
     * @type {number}
     */
    percentage = 100;
     ...
     * Initializes the status bar's image, position, size, and sets the initial health percentage.
     */
    constructor() {
        super();
